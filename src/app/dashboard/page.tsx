...
export default function DashboardPage() {
  ...
  const [taskService, setTaskService] = useState<TaskService | LocalTaskService | null>(null)
  ...
  const handleCreateTask = async (data: TaskFormData) => {
    ...
    try {
      ...
      if (isGuestMode) {
        ...
        const newTask = localService.createTask({
          user_id: 'guest',
          title: data.title,
  ...
  const handleToggleStatus = async (id: string, status: string) => {
    ...
    try {
      if (isGuestMode) {
        const localService = taskService as LocalTaskService
        const updatedTask = localService.updateTask(id, { status: status as any })
        ...
        const service = taskService as TaskService
        const updatedTask = await service.updateTask(id, { status: status as any })
