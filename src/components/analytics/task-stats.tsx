  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <Card className="p-4 md:col-span-2 lg:col-span-4">
        <h3 className="text-lg font-semibold text-gray-700 mb-3">Priority Distribution</h3>
        <div className="flex justify-around">
          <div className="text-center">
            <Badge variant="destructive" className="mb-1">High Priority</Badge>
            <p className="text-2xl font-bold">{priorityStats.high}</p>
          </div>
          <div className="text-center">
            <Badge variant="default" className="mb-1">Medium Priority</Badge>
            <p className="text-2xl font-bold">{priorityStats.medium}</p>
          </div>
          <div className="text-center">
            <Badge variant="secondary" className="mb-1">Low Priority</Badge>
